...
const ProductionDetails = ({ data }: { data?: InventoryListType }) => {
  ...
  return (
    <div className='flex flex-col gap-10'>
      <Typography variant='h5'>{`Manufactured Products`}</Typography>
      ...
      <Card>
        <CardContent className='flex flex-wrap items-center justify-between gap-4 pbe-6'>
          <div>
            ...
            <Typography>
              {/* @ts-ignore */}
              <span className='font-medium text-textPrimary'>{ data?.productCategory.title }</span>
            </Typography>
          </div>
        </CardContent>
        <CardContent>
          <div className='border rounded'>
            ...
            <div className='flex flex-col gap-6 p-5'>
              <div className='flex flex-col gap-4'>
                <Typography variant='h5'>Product Invoice Number</Typography>
                ...
                <div className='flex flex-wrap gap-x-12 gap-y-2'>
                  <List role='list' component='div' className='flex flex-col gap-2 plb-0'>
                    ...
                    <ListItem role='listitem' className='flex items-center gap-2 p-0'>
                      ...
                      <Typography>Quantity Per Box: {
                        // @ts-ignore
                      data?.qtyPerPackage}</Typography>
                    </ListItem>
                    <ListItem role='listitem' className='flex items-center gap-2 p-0'>
                  ...
                  <List role='list' component='div' className='flex flex-col gap-2 plb-0'>
                    <ListItem role='listitem' className='flex items-center gap-2 p-0'>
                      <i className='ri-article-line text-xl text-textSecondary' />
                      <Typography>Batch Number: {data?.batchNumber}</Typography>
                    </ListItem>
                    <ListItem role='listitem' className='flex items-center gap-2 p-0'>
                    ...
                    <ListItem role='listitem' className='flex items-center gap-2 p-0'>
                      ...
                      <Typography>Cost of one item in box: {formatPrice(data?.priceOfOneItem ?? 0)}</Typography>
                    </ListItem>
                  </List>
                </div>
              </div>
              ...
              <Divider />
              <div className='flex flex-col gap-4'>
                <Typography variant='h5'>Production added by:</Typography>
