...
import { createPickupLocation, CreatePickupLocationData } from '@/libs/actions/location.actions'
import { WEST_AFRICAN_COUNTRIES } from '@/data/countries'

interface AddPickupLocationDrawerProps {
  open: boolean
  onClose: () => void
  onSuccess: () => void
}

const AddPickupLocationDrawer: React.FC<AddPickupLocationDrawerProps> = ({
  open,
  onClose,
  onSuccess
}) => {
