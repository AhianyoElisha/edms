...
const ProductListTable = () => {
  ...
  const fetchInventoryData = useCallback(async () => {
    try {
      setIsLoading(true)
      const response = await getWarehouseProductList()
          ...
          <div className='flex items-center'>
            <OptionMenu
              ...
              options={[
                { text: 'Details', 
                  icon: 'ri-stack-line',
                  menuItemProps: { onClick: () => router.push(`/warehouse/${row.original.$id}`) }
                },
  ...
  return (
    <>
      <Typography className='mt-4' variant='h3'>Warehouse Stored Products Report</Typography>
