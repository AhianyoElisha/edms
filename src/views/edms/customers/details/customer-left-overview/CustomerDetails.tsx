      ...
      <CardContent className='flex flex-col pbs-12 gap-6'>
        <div className='flex flex-col justify-self-center items-center gap-6'>
          <div className='flex flex-col items-center gap-4'>
            <CustomAvatar src={''} variant='rounded' alt='Customer Avatar' size={120} />
            <div className='flex flex-col items-center text-center'>
              <Typography variant='h5'>{customerData?.customer}</Typography>
              <Typography>Customer ID #{customerData?.$id!.toString().slice(0, 8)}</Typography>
            </div>
          </div>
          <div className='flex items-center justify-around gap-4 flex-wrap is-full'>
            <div className='flex items-center gap-4'>
              ...
              <div>
                <Typography variant='h5'>{customerData?.orders?.length}</Typography>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <div className='flex items-center gap-1'>
              ...
              <Typography>{customerData?.contact1}</Typography>
            </div>
            <div className='flex items-center gap-1'>
              <Typography color='text.primary' className='font-medium'>
                Country:
