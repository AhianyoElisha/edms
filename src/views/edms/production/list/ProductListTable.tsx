...
const ProductListTable = () => {
  ...
  const fetchProductionData = useCallback(async () => {
    try {
      setIsLoading(true)
      const response = await getManufacturedProductList()
  ...
  const columns = useMemo<ColumnDef<ProductWithActionsType, any>[]>(
    () => [
      ...
      columnHelper.accessor('$createdAt', {
        ...
        cell: ({ row }) => {
          const dateString = row.original.manufactureDate!;
          let formattedDate;
  ...
  return (
    <>
      <Typography className='mt-4' variant='h3'>Manufactured Products Report</Typography>
