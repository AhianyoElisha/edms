...
// Type Imports
import type { DistributedItemDetailType, ManufacturedProductListType, ProductionCategoryType, TransactionItemDetailType, WorkerDetailType } from '@/types/apps/ecommerceTypes'
...
const TableFilters = ({
  setData,
  workerProductionData,
  categoryData
}: {
  setData: (data: WorkerDetailType[]) => void
    workerProductionData?: WorkerDetailType[]
  ...
  useEffect(() => {
    const filteredData = workerProductionData?.filter(product => {
        // @ts-ignore
  ...
  }, [category, date, workerProductionData, setData])
