...
import { CategoryType, ProductionCategoryType } from '@/types/apps/ecommerceTypes'
...
const DistributionCategory = ({ control, index, name, error, onCategorySelect }: ProductCategoryProps) => {
