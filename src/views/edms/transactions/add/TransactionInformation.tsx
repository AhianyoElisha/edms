        ...
        <CardContent>
          <Grid container spacing={5} className='mbe-5'>
            ...
            <Grid item xs={12} sm={6}>
              <Typography variant='h6' className='mb-2'>Sales Date</Typography>
                <Controller
            ...
            <Grid item xs={12} md={6}>
              <Typography variant='h6' className='mb-2'>Quantity Sold</Typography>
              <Controller
            ...
            <Grid item xs={12} md={6}>
              <Typography variant='h6' className='mb-2'>Selling Price</Typography>
                <Controller
                  name={names.salesPrice}
                  control={control}
                  render={({ field }) => (
                    <TextField 
                      fullWidth 
