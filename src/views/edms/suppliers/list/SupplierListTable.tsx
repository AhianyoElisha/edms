...
import type { Customer, Supplier } from '@/types/apps/ecommerceTypes'
...
import { getCustomerList, getSupplierList } from '@/libs/actions/customer.action'
...
type ECommerceOrderTypeWithAction = Supplier & {
  actions?: string
}
...
const SupplierListTable = () => {
  // States
  const [supplierUserOpen, setSupplierUserOpen] = useState(false)
  ...
  const fetchSupplierData = useCallback(async () => {
    try {
      ...
      setData(response?.documents as unknown as Supplier[])
    } catch (error) {
...
console.log(data)
        ...
        cell: ({ row }) => (
          <div className='flex items-center gap-3'>
            ...
            <div className='flex flex-col items-start'>
              <Link href={`/supplier/${row.original.$id}`}>
                <Typography
                  color='text.primary'
          ...
          <div className='flex items-center'>
            <OptionMenu
              ...
              options={[
                { text: 'Details', 
                  icon: 'ri-stack-line',
                  menuItemProps: { onClick: () => router.push(`/suppliers/${row.original.$id}`) }
                },
              ]}
            />
          </div>
  ...
  return (
    <>
      <Typography className='mt-4' variant='h4'>Suppliers List</Typography>
        ...
        <CardContent className='flex justify-between flex-wrap max-sm:flex-col sm:items-center gap-4'>
          ...
          <div className='flex gap-4 max-sm:flex-col max-sm:is-full'>
            ...
            <Button
              ...
              onClick={() => setSupplierUserOpen(!supplierUserOpen)}
            >
              Add Supplier
            </Button>
          </div>
      ...
      <AddSupplierDrawer
        open={supplierUserOpen}
        handleClose={() => setSupplierUserOpen(!supplierUserOpen)}
        supplierData={data}
