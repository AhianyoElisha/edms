...
const ProductionStoreRequisitionTable = ({ refreshTrigger }: ProductionStoreRequisitionTableProps) => {
  // States
  ...
  const fetchInventoryData = useCallback(async () => {
    try {
      ...
      setAllData(data?.inventoryList.documents as unknown as CategoryType[])
    } catch (error) {
  ...
  return (
    <>
      <Typography className='mt-4' variant='h4'>Inventory Requisition From Stores</Typography>
...
export default ProductionStoreRequisitionTable
