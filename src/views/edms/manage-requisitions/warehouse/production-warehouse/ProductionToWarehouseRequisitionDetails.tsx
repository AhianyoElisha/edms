...
// Component Imports
import ProductAddHeader from '@/views/edms/manage-requisitions/warehouse/production-warehouse/RequisitionAddHeader'
import ProductInformation from '@/views/edms/manage-requisitions/warehouse/production-warehouse/RequisitionInformation'
...
const ProductionToWarehouseRequisitionDetails = ({ onSuccessfulSubmit }: ProductionToWarehouseRequisitionDetailsProps) => {
  ...
  return (
    <Card elevation={0}>
      <CardHeader
        title='Production to Warehouse Requisition Details'
      />
      <CardContent>
