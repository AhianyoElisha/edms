...
// Type Imports
import type { DistributedItemDetailType, ManufacturedProductListType, ProductionCategoryType, ReturnItemDetailType, TransactionItemDetailType } from '@/types/apps/ecommerceTypes'
...
const TableFilters = ({
  ...
  setData: (data: ReturnItemDetailType[]) => void
    returnedProductsData?: ReturnItemDetailType[]
  ...
  useEffect(() => {
    const filteredData = returnedProductsData?.filter(product => {
        // @ts-ignore
  ...
  }, [category, date, returnedProductsData, setData])
