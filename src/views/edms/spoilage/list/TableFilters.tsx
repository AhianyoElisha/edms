...
// Type Imports
import type { DistributedItemDetailType, ManufacturedProductListType, ProductionCategoryType, TransactionItemDetailType } from '@/types/apps/ecommerceTypes'
...
const TableFilters = ({
  ...
  setData: (data: TransactionItemDetailType[]) => void
    productData?: TransactionItemDetailType[]
