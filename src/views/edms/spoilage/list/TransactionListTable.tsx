...
import type { DistributedItemDetailType, InventoryListType, ManufacturedProductListType, ProductDetailsType, ProductionCategoryType, TransactionItemDetailType } from '@/types/apps/ecommerceTypes'
  ...
  const columns = useMemo<ColumnDef<TransactionWithActionsType, any>[]>(
    () => [
      ...
      columnHelper.accessor('customer', {
        ...
        cell: ({ row }) => <Typography>{
        // @ts-ignore
          row.original.customers.customer || "General Sale"
        }</Typography>
      }),
