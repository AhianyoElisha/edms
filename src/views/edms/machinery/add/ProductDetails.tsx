...
// Component Imports
import ProductAddHeader from '@/views/edms/machinery/add/ProductAddHeader'
import ProductInformation from '@/views/edms/machinery/add/ProductInformation'
import ProductImage from '@/views/edms/machinery/add/ProductImage'
