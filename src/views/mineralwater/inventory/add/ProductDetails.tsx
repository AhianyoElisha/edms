...
// Component Imports
import ProductAddHeader from '@/views/mineralwater/inventory/add/ProductAddHeader'
import ProductInformation from '@/views/mineralwater/inventory/add/ProductInformation'
import ProductImage from '@/views/mineralwater/inventory/add/ProductImage'
import ProductCategory from '@/views/mineralwater/inventory/add/ProductCategory'
