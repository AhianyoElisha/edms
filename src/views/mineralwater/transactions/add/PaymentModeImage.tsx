...
const PaymentModeImage = ({ control, index, name }: TransactionImageProps) => {
  const {
    ...
    name,
    control,
    rules: { required: "At least one payment receipt image is required" }
  })
  ...
  return (
    <Dropzone>
      <Card>
        <CardHeader title={`Payment Receipt Image`} />
        <CardContent>
