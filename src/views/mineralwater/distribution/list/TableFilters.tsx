...
// Type Imports
import type { DistributedItemDetailType, ManufacturedProductListType, ProductionCategoryType } from '@/types/apps/ecommerceTypes'
...
const TableFilters = ({
  ...
  setData: (data: DistributedItemDetailType[]) => void
    productData?: DistributedItemDetailType[]
    categoryData?: ProductionCategoryType[]
}) => {
  // States
  // @ts-ignore
  const [category, setCategory] = useState<DistributedItemDetailType['productCategory.title']>('')
