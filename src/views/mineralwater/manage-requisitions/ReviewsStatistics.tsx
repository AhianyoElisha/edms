...
// Vars
const series = [{ data: [32, 52, 72, 94, 81, 94, 72] }]

const RequisitionStatistics = () => {
  // Hook
          ...
          <Grid item xs={12} sm={6}>
            <div className='bs-full flex flex-col items-start justify-between gap-6'>
              <div className='flex flex-col items-start gap-2'>
                <Typography variant='h5'>Requisition statistics</Typography>
                <div className='flex items-center gap-2'>
                  <Typography>5 New requisitions</Typography>
                  <Chip label='+8.4%' variant='tonal' size='small' color='success' />
                </div>
              </div>
              <div className='flex flex-col items-start gap-2'>
                <Typography color='text.primary'>
                  <span className='text-success'>87%</span> Approved requsitions
                </Typography>
...
export default RequisitionStatistics
