...
import { saveCustomerToDB, updateCustomerInDB } from '@/libs/actions/customer.action'
...
const EditCustomerDrawer = (props: Props) => {
  const { open, handleClose,customerData, onSuccess } = props
  const [isSubmitting, setIsSubmitting] = useState(false)
  const [error, setError] = useState<string | null>(null)
  console.log('Customer Data in Drawer:', customerData)
  ...
  const onSubmit = async (data: Customer) => {
    try {
      ...
      const res = await updateCustomerInDB({...data, id: customerData.$id})
