...
import { saveCustomerToDB, saveTruckOrTricycleToDB } from '@/libs/actions/customer.action'
...
const AddLogisticsDrawer = (props: Props) => {
  ...
  const onSubmit = async (data: Logistics) => {
    try {
      ...
      const res = await saveTruckOrTricycleToDB(data)
  ...
  return (
    ...
    >
      <div className='flex items-center justify-between p-5'>
        <Typography variant='h5'>Add a Delivery Vehicle</Typography>
