...
import { createDropoffLocation, CreateDropoffLocationData } from '@/libs/actions/location.actions'
import { WEST_AFRICAN_COUNTRIES } from '@/data/countries'

interface AddDropoffLocationDrawerProps {
  open: boolean
  onClose: () => void
  onSuccess: () => void
}

const AddDropoffLocationDrawer: React.FC<AddDropoffLocationDrawerProps> = ({
  open,
  onClose,
  onSuccess
}) => {
  ...
  const validateForm = (): string | null => {
    ...
    if (!selectedCoordinates) return 'Please select location coordinates on the map'
    return null
  }
...
export default AddDropoffLocationDrawer