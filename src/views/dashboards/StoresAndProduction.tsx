  ...
  return (
    <AppKeenSlider className='bs-full'>
      <Card className='bs-full'>
        <CardHeader
          title='Stores & Production'
          subheader={
            <div className='flex items-center gap-2'>
              <Typography variant='subtitle1'>Total Profit and Loss</Typography>
...
export default StoresAndProduction
