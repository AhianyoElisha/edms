...
// Component Imports
import Details from '@/views/mineralwater/requisition-details/machinery/Details'
import Sidebar from '@/views/mineralwater/requisition-details/machinery/Sidebar'
