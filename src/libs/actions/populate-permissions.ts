...
export async function createPermissions() {
  ...
  console.log(`🎉 Finished creating ${results.length} permissions out of ${permissions.length} total!`);
  return results;
}
...
export async function createRoles() {
  ...
  console.log(`🎉 Finished creating ${results.length} roles out of ${roles.length} total!`);
  return results;
}

export async function populatePermissionsAndRoles() {
  try {
    ...
    console.log('\n📝 Summary:');
    console.log(`   - Permissions created: ${createdPermissions.length}/${permissions.length}`);
...
// Export individual arrays for other uses
export { permissions as permissionsList, roles as rolesList };