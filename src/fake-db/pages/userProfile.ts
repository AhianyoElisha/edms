  ...
  users: {
    profile: {
      about: [
        ...
        { property: 'Country', value: 'Ghana', icon: 'ri-flag-line' },
    ...
    teams: [
      ...
      },
      {
        ...
        description:
          'Explore, install, use, and remix thoGhanands of plugins and files published to the Figma Community by designers.',
        chips: [
          {
            title: 'UI/UX',
            color: 'success'
